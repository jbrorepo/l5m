...
`runs/convomem_full_hybrid_parent_leader.jsonl` vs `runs/convomem_full_bm25.jsonl`: R@1 0.3328 vs 0.3323, R@5 0.7490 vs 0.5343, R@10 0.8134 vs 0.6259; P50 1311900 ns vs 1920000 ns (1.46x), P95 3551100 ns vs 4778400 ns (1.35x); gate violations 0.

## Raw Metrics

| Run | Queries | R@1 | R@5 | R@10 | NDCG@5 | NDCG@10 | MRR | Zero Recall | P50 ns | P95 ns | P99 ns |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| runs/convomem_full_hybrid_parent_leader.jsonl | 75336 | 0.3328 | 0.7490 | 0.8134 | 0.5969 | 0.6290 | 0.5600 | 0.0416 | 1311900 | 3551100 | 5109700 |
