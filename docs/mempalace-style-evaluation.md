...
For ConvoMem `hybrid-parent`, the runner preserves the lexical top parent at rank 1, then applies hybrid parent aggregation to the remaining returned parents. This keeps BM25's strong first-rank ordering while retaining L5M's lower duplicate rate and stronger top-5/top-10 coverage.
